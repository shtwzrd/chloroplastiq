...
namespace Chloroplastiq.TurtleGraphics
{
    public class LInterpreter
    {
        ...
        public string GetGrammar()
        {
            ...
            var rules = Lindenmayer.Helper.toMap<char, string>(LSystem.Rules);

            String lastGeneration = Lindenmayer.System.generation(LSystem.Axiom, rules);

            for (int i = 1; i < Iterations; i++)
            {
                lastGeneration = Lindenmayer.System.generation(lastGeneration, rules);
            }
